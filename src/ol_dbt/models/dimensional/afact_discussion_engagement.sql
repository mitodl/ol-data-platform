with
    ...
    discussion_topics as (select * from {{ ref("dim_discussion_topic") }}),
...
left join
    discussion_topics
    on aggregated.commentable_id = discussion_topics.commentable_id
    and aggregated.courserun_readable_id = discussion_topics.courserun_readable_id
left join course_content on discussion_topics.content_block_fk = course_content.content_block_pk
