...
with
    mitxonline_navigation_events as (
        select
            user_username,
            openedx_user_id,
        ...
        where courserun_readable_id is not null and useractivity_event_type in {{ navigation_events }}
    ),
    ...
    combined as (
        select
            ...
            coalesce(
                mitxonline_navigation_events.ending_tab, mitxonline_navigation_events.ending_url
            ) as ending_position,
            mitxonline_navigation_events.current_tab,
        ...
        left join
            users
            on mitxonline_navigation_events.openedx_user_id = users.mitxonline_openedx_user_id
        ...
        left join
            users
            on xpro_navigation_events.openedx_user_id = users.mitxpro_openedx_user_id
        ...
        select
            ...
            coalesce(
                mitxresidential_navigation_events.ending_tab, mitxresidential_navigation_events.ending_url
            ) as ending_position,
            mitxresidential_navigation_events.current_tab,
        ...
        left join
            users
            on mitxresidential_navigation_events.user_id = users.residential_openedx_user_id
        ...
        select
            ...
            coalesce(edxorg_navigation_events.ending_tab, edxorg_navigation_events.ending_url) as ending_position,
            edxorg_navigation_events.current_tab,
        ...
        left join
            users
            on edxorg_navigation_events.user_id = users.edxorg_openedx_user_id
