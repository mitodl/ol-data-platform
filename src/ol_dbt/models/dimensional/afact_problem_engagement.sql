with
    problem_structure as (
        ...
        where block_category = 'problem' and is_latest = true
    ),
    ...
    combined as (
        ...
        left join problem_structure on problem_attempt_aggregated.problem_block_fk = problem_structure.problem_block_fk
    )
