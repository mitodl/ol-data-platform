...
, sequentials as (
    ...
    where coursestructure_block_category = 'sequential'
)
...
, combined_with_sequentials as (
    ...
    from combined
    inner join sequentials
        on
            combined.courserun_readable_id = sequentials.courserun_readable_id
...
, combined_with_chapters as (
    ...
    inner join chapters
        on
            combined.courserun_readable_id = chapters.courserun_readable_id
...
, combined_course_content as (
    ...
    left join combined_with_chapters
        on
            combined.courserun_readable_id = combined_with_chapters.courserun_readable_id
    ...
    left join combined_with_sequentials
        on
            combined.courserun_readable_id = combined_with_sequentials.courserun_readable_id
