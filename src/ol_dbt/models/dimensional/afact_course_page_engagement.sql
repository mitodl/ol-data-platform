with
    vertical_structure as (
        ...
        where block_category = 'vertical' and is_latest = true
    ),
    ...
    combined as (
        ...
        left join vertical_structure on page_navigation_events.block_fk = vertical_structure.block_id
    )
