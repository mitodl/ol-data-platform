...
with
    mitxonline_discussion_events as (
        select
            user_username,
            openedx_user_id,
        ...
        where courserun_readable_id is not null and useractivity_event_type like '{{ discussion_events }}'
    ),
    ...
    combined as (
        ...
        left join
            users
            on mitxonline_discussion_events.openedx_user_id = users.mitxonline_openedx_user_id
        ...
        left join
            users
            on xpro_discussion_events.openedx_user_id = users.mitxonline_openedx_user_id
        ...
        left join
            users
            on mitxresidential_discussion_events.openedx_user_id = users.residential_openedx_user_id
        ...
        left join
            users
            on edxorg_discussion_events.openedx_user_id = users.edxorg_openedx_user_id
