with
    users as (select * from {{ ref("stg__bootcamps__app__postgres__auth_user") }}),
    users_legaladdress as (select * from {{ ref("stg__bootcamps__app__postgres__profiles_legaladdress") }}),
    users_profile as (select * from {{ ref("stg__bootcamps__app__postgres__profiles_profile") }})
