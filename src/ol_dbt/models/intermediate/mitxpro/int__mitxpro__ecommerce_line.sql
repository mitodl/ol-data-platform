with
    lines as (select * from {{ ref("stg__mitxpro__app__postgres__ecommerce_line") }}),
    ...
    programrunlines as (select * from {{ ref("stg__mitxpro__app__postgres__ecommerce_programrunline") }})
