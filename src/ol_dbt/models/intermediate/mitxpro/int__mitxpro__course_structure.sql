with
    ...
    chapters as (select * from course_structure where coursestructure_block_category = 'chapter'),
    course_structure_with_chapters as (
        ...
        inner join
            chapters
            on course_structure.courserun_readable_id = chapters.courserun_readable_id
...
from course_structure
left join
    latest_course_structure_date
    on course_structure.courserun_readable_id = latest_course_structure_date.courserun_readable_id
    and course_structure.coursestructure_retrieved_at = latest_course_structure_date.max_retrieved_date
left join
    course_structure_with_chapters
    on course_structure.courserun_readable_id = course_structure_with_chapters.courserun_readable_id
