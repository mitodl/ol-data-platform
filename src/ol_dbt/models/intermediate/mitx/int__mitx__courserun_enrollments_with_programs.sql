with
    edx_enrollments as (
        select * from {{ ref("int__mitx__courserun_enrollments") }} where platform = '{{ var("edxorg") }}'
    ),
    ...
    edx_query as (
        ...
        left join mitx_users on edx_enrollments.user_id = mitx_users.user_edxorg_id
    ...
    mitxonline_query as (
        ...
        left join mitx_users on mitxonline_enrollments_with_program.user_id = mitx_users.user_mitxonline_id
