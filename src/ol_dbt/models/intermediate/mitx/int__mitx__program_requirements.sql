with
    micromasters_program_requirements as (select * from {{ ref("int__micromasters__program_requirements") }}),
    mitxonline_program_requirements as (select * from {{ ref("int__mitxonline__program_requirements") }}),
    courses as (select * from {{ ref("int__mitx__courses") }}),
...
from programs
inner join
    mitxonline_program_requirements on programs.mitxonline_program_id = mitxonline_program_requirements.program_id
inner join courses on mitxonline_program_requirements.course_id = courses.mitxonline_course_id
...
from programs
inner join
    micromasters_program_requirements on programs.micromasters_program_id = micromasters_program_requirements.program_id
inner join courses on micromasters_program_requirements.course_id = courses.micromasters_course_id
