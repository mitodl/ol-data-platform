...
with
    ...
    mitxonline_courserunenrollments as (select * from {{ ref("int__mitxonline__courserunenrollments") }}),
    ...
    query as (
        select
            ...
            case
                ...
                when
                    mitxonline_courseruns.courserun_start_on < to_iso8601(
        ...
        inner join
            mitxonline_courseruns on mitxonline_courserunenrollments.courserun_id = mitxonline_courseruns.courserun_id
        left join
