with
    mitxonline_coursevideos as (select * from {{ ref("stg__mitxonline__openedx__mysql__edxval_coursevideo") }}),
    mitxonline_videos as (select * from {{ ref("stg__mitxonline__openedx__mysql__edxval_video") }}),
    ovs_videos as (
