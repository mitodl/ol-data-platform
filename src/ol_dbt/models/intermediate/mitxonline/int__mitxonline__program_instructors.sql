with
    instructors as (select * from {{ ref("stg__mitxonline__app__postgres__cms_instructorpage") }}),
    instructor_pagelinks as (select * from {{ ref("stg__mitxonline__app__postgres__cms_instructorpagelink") }}),
