with transactions as (select * from {{ ref("stg__mitxonline__app__postgres__ecommerce_transaction") }})
...
select
    ...
    json_query(transaction_data, 'lax $.req_bill_to_address_country' omit quotes) as transaction_bill_to_address_country
    ,
