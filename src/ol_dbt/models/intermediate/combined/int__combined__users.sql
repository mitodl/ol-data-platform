...
with
    ...
    mitxpro_users as (select * from {{ ref("int__mitxpro__users") }}),
    bootcamps_users as (select * from {{ ref("int__bootcamps__users") }}),
    edxorg_users as (select * from {{ ref("int__edxorg__mitx_users") }}),
    residential_users as (select * from {{ ref("int__mitxresidential__users") }}),
