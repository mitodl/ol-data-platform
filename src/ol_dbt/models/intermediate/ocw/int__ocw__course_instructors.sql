with
    ...
    unnested_instructor_contents as (
        select websitecontents.website_uuid as course_uuid, course_instructor_uuid  -- noqa
        from websitecontents
        cross join unnest(cast(json_parse(course_instructor_uuids) as array(varchar))) as t(course_instructor_uuid)  -- noqa
