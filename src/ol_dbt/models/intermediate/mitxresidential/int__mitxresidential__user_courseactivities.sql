with
    ...
    course_activities_video as (select * from {{ ref("int__mitxresidential__user_courseactivity_video") }}),
    problem_check as (select * from {{ ref("int__mitxresidential__user_courseactivity_problemcheck") }}),
