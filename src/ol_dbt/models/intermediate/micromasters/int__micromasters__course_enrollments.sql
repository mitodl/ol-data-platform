with
    mitx_enrollments as (select * from {{ ref("int__mitx__courserun_enrollments_with_programs") }}),
...
inner join
    programs
    on mitx_enrollments.micromasters_program_id = programs.micromasters_program_id
