...
with
    mitxonline_program_certificates as (select * from {{ ref("int__mitxonline__program_certificates") }}),
...
where mitx_programs.is_dedp_program = true and mitxonline_program_certificates.programcertificate_is_revoked = false
