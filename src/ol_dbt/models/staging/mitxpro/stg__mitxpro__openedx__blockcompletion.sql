...
with source as (
    ...
    {{
      ...
      ,'raw__xpro__openedx__mysql__completion_blockcompletion')
    }}
...
{{ deduplicate_raw_table(raw_table='raw__xpro__openedx__mysql__completion_blockcompletion', partition_columns = 'id') }}
, cleaned as (
