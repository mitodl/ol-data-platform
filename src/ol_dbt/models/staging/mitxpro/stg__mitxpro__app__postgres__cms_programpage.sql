with
    programpage as (select * from {{ source("ol_warehouse_raw_data", "raw__xpro__app__postgres__cms_programpage") }}),
...
left join programpage on externalprogrampage.program_id = programpage.program_id
