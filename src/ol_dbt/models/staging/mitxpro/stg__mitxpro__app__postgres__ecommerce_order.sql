with
    source as (select * from {{ source("ol_warehouse_raw_data", "raw__xpro__app__postgres__ecommerce_order") }}),
    renamed as (
        select
            id as order_id,
            ...
            cast(
                (total_price_paid * (tax_rate / 100)) + total_price_paid as decimal(38, 2)
