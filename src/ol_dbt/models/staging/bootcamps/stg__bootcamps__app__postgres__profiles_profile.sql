with
    source as (select * from {{ source("ol_warehouse_raw_data", "raw__bootcamps__app__postgres__profiles_profile") }}),
    cleaned as (
        select
            ...
            case
                ...
                then '2-5 years'
                when years_experience = 10
                then '6 - 10 years'
                when years_experience = 15
                then '11 - 15 years'
                when years_experience = 20
                then '16 - 20 years'
                when years_experience = 21
