...
{{ deduplicate_raw_table(raw_table='raw__mitxonline__app__postgres__wagtailimages_image', partition_columns='id') }}

, cleaned as (
    select
        id as image_id
        , file as image_file
        , concat('{{ var("mitxonline_media_url") }}', file) as image_url
