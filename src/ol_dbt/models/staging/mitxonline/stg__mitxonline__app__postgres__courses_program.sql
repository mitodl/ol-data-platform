...
with
    source as (select * from {{ source("ol_warehouse_raw_data", "raw__mitxonline__app__postgres__courses_program") }}),
    cleaned as (
        select
            id as program_id,
            ...
            if(
                program_type like 'MicroMasters%', 'MicroMasters Credential', 'Certificate of Completion'
