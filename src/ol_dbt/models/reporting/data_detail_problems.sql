...
select
    ...
    problems.markdown
from problem_events
inner join problems on problem_events.problem_block_fk = problems.problem_block_pk
inner join combined__course_runs on problem_events.courserun_readable_id = combined__course_runs.courserun_readable_id
