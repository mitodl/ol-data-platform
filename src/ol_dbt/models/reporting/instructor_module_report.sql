...
, video_views_table as (
    ...
    inner join user
        on video_pre_query.user_fk = user.user_pk
...
, combined_data as (
    ...
    group by    
        ...
        , chatbot_events.chatbot_type
        , case when enroll_activity.user_email is not null then true else false end
        , null
        , null
        , null
        , 0
