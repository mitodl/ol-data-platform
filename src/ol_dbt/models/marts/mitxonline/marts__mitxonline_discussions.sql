with
    discussions as (select * from {{ ref("int__mitxonline__user_courseactivity_discussion") }}),
...
left join
    users on discussions.user_username = users.user_username and discussions.openedx_user_id = users.openedx_user_id
