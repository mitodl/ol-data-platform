...
select 
    ...
    , case when mitx_courserun_enroll_w_programs.platform= 'MITx Online' 
    ...
    , case when mitx_courserun_enroll_w_programs.platform= 'MITx Online' 
        ...
        else null end as program_id
    , mitx__courses.course_readable_id
from int__mitx__courserun_enrollments_with_programs mitx_courserun_enroll_w_programs
inner join int__mitx__courses mitx__courses
