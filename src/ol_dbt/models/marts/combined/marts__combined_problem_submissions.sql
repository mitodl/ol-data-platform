...
inner join
    combined_runs
    on combined_problem_checks.courserun_readable_id = combined_runs.courserun_readable_id
    and combined_problem_checks.platform = combined_runs.platform
left join
    combined_users
    on combined_problem_checks.user_username = combined_users.user_username
