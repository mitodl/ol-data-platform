...
, enrollments as (
    ...
    select
        ...
        , count(distinct micromasters_enrollments.courserun_readable_id || micromasters_enrollments.user_email)
...
, program_certs as (
    select
        ...
        when 
            ...
            then 'Statistics and Data Science'
        when micromasters_program_certificates.program_title = 'MIT Finance' then 'Finance'
    ...
    select
        ...
        when 
            ...
            in ('Statistics and Data Science', 'Statistics and Data Science (General track)') 
            then 'Statistics and Data Science'
        when 
            micromasters_program_certificates.program_title = 'MIT Finance' then 'Finance'
        else micromasters_program_certificates.program_title end 
        || micromasters_program_certificates.user_email) as program_certificates
    from micromasters_program_certificates
    left join mitxonline_program_certificates
        on 
            micromasters_program_certificates.mitxonline_program_id = mitxonline_program_certificates.program_id
