...
, program_product_versions as (
    ...
    group by program_product.program_id, program_contenttype.contenttype_id
)
...
select
    ...
    , program_product_versions.program_id as product_object_id
...
left join program_product_versions
      on mitxonline_programs.program_id = program_product_versions.program_id
