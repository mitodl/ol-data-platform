...
def bootcamps_qa_app_db_to_datalake_raw():
    return [
        sync_assets_and_run_models.to_job(
            ...
            resource_defs={"airbyte": airbyte_resource, "dbt": dbt_cli_resource.configured({"project_dir": "/opt/dbt/models/staging/bootcamps", "profiles_dir": "/opt/dbt"})},
            config={"ops": {
                        "sync_airbyte": {
                            "config": {
...
def mitxonline_qa_app_db_to_datalake_raw():
    return [
        sync_assets_and_run_models.to_job(
            ...
            resource_defs={"airbyte": airbyte_resource, "dbt": dbt_cli_resource.configured({"project_dir": "/opt/dbt/models/staging/mitxonline", "profiles_dir": "/opt/dbt"})},
            config={"ops": {
                        "sync_airbyte": {
                            "config": {
...
def mitxpro_qa_app_db_to_datalake_raw():
    return [
        sync_assets_and_run_models.to_job(
            ...
            resource_defs={"airbyte": airbyte_resource, "dbt": dbt_cli_resource.configured({"project_dir": "/opt/dbt/models/staging/mitxpro", "profiles_dir": "/opt/dbt"})},
            config={"ops": {
                        "sync_airbyte": {
                            "config": {
...
def mitx_residential_qa_openedx_db_to_datalake_raw():
    return [
        sync_assets_and_run_models.to_job(
            ...
            resource_defs={"airbyte": airbyte_resource, "dbt": dbt_cli_resource.configured({"project_dir": "/opt/dbt", "profiles_dir": "/opt/dbt"})},
            config={"ops": {
                        "sync_airbyte": {
                            "config": {
