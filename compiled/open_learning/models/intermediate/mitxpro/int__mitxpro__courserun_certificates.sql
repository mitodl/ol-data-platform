...
with certificates as (
    select * from dev.main_staging.stg__mitxpro__app__postgres__courses_courseruncertificate
)

, runs as (
    select * from dev.main_staging.stg__mitxpro__app__postgres__courses_courserun
)

, users as (
    select * from dev.main_staging.stg__mitxpro__app__postgres__users_user
)
