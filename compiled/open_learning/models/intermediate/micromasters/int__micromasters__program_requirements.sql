...
, courses as (
    select * from dev.main_staging.stg__micromasters__app__postgres__courses_course
)

, electiveset as (
    select * from dev.main_staging.stg__micromasters__app__postgres__courses_electiveset
)

, electiveset_to_course as (
    select * from dev.main_staging.stg__micromasters__app__postgres__courses_electiveset_to_course
)
