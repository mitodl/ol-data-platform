...
with certificates as (
    select * from dev.main_staging.stg__bootcamps__app__postgres__courses_courseruncertificate
)

, runs as (
    select * from dev.main_staging.stg__bootcamps__app__postgres__courses_courserun
)

, users as (
    select * from dev.main_staging.stg__bootcamps__app__postgres__auth_user
)
