...
with certificates as (
    select * from dev.main_staging.stg__mitxonline__app__postgres__courses_courseruncertificate
)
...
, users as (
    select * from dev.main_staging.stg__mitxonline__app__postgres__users_user
)
