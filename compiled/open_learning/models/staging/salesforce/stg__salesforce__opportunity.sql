...
with source as (
    ...
    select *
    from dev.main_raw.raw__thirdparty__salesforce__opportunity
...
, renamed as (
    ...
    select
        ...
        ,
        to_iso8601(from_iso8601_date(closedate))
        as opportunity_close_date
        ,
        to_iso8601(from_iso8601_timestamp(createddate))
        as opportunity_created_on
        ,
        to_iso8601(from_iso8601_timestamp(systemmodstamp))
        as opportunity_modified_on
