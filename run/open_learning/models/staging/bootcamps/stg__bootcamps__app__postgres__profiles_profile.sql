    ...
    create table ol_data_lake_qa.ol_warehouse_qa_staging.stg__bootcamps__app__postgres__profiles_profile__dbt_tmp
    WITH (format = 'PARQUET')
  as (
    with source as (
    select * from ol_data_lake_qa.ol_warehouse_qa_raw.raw__bootcamps__app__postgres__profiles_profile
)
