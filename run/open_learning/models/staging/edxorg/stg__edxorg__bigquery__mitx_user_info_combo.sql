    ...
    create table ol_data_lake_qa.ol_warehouse_qa_tmacey_staging.stg__edxorg__bigquery__mitx_user_info_combo__dbt_tmp
    WITH (format = 'PARQUET')
  as (
...
with source as (
    select *
    from ol_data_lake_qa.ol_warehouse_qa_raw.raw__irx__edxorg__bigquery__mitx_user_info_combo
)
...
, cleaned as (
    ...
    select
        ...
        case
            ...
            when enrollment_course_id like 'xPRO%' or enrollment_course_id like 'MITxPRO%' then 'xPro'
