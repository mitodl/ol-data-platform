    ...
    create table ol_data_lake_qa.ol_warehouse_qa_tmacey_staging.stg__edxorg__bigquery__mitx_courserun__dbt_tmp
    WITH (format = 'PARQUET')
  as (
...
with source as (
    ...
    select * from ol_data_lake_qa.ol_warehouse_qa_tmacey.raw__irx__edxorg__bigquery__mitx_course
