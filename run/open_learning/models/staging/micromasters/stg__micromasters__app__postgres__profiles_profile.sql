create table ol_data_lake_production.ol_warehouse_production_staging.stg__micromasters__app__postgres__profiles_profile__dbt_tmp
...
as (
    ...
    with source as (
        select *
        from ol_data_lake_production.ol_warehouse_production_raw.raw__micromasters__app__postgres__profiles_profile
    )
    ...
    , cleaned as (
        select
            ...
            ,
            to_iso8601(from_iso8601_timestamp(date_of_birth))
            as user_birth_date
