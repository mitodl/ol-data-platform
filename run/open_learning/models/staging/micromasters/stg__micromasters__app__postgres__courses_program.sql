create table ol_data_lake_production.ol_warehouse_production_staging.stg__micromasters__app__postgres__courses_program__dbt_tmp
...
as (
    ...
    with source as (
        select *
        from ol_data_lake_production.ol_warehouse_production_raw.raw__micromasters__app__postgres__courses_program
    )
