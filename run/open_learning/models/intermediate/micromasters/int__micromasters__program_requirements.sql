create table ol_data_lake_production.ol_warehouse_production_intermediate.int__micromasters__program_requirements__dbt_tmp
...
as (
    ...
    , electiveset as (
        select *
        from
            ol_data_lake_production.ol_warehouse_production_staging.stg__micromasters__app__postgres__courses_electiveset
    )
