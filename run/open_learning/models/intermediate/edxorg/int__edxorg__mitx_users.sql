create table ol_data_lake_production.ol_warehouse_production_intermediate.int__edxorg__mitx_users__dbt_tmp
...
as (
    ...
    , email_opt_in as (
        ...
        from ol_data_lake_production.ol_warehouse_production_staging.stg__edxorg__bigquery__mitx_user_email_opt_in
    )
