create table ol_data_lake_production.ol_warehouse_production_intermediate.int__edxorg__mitx_user_courseactivities__dbt_tmp

as (
    with person_courses as (
        select * from ol_data_lake_production.ol_warehouse_production_staging.stg__edxorg__bigquery__mitx_person_course
    )
