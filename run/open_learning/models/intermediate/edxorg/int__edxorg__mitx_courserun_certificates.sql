create table ol_data_lake_production.ol_warehouse_production_intermediate.int__edxorg__mitx_courserun_certificates__dbt_tmp
...
as (
    ...
    , runs as (
        select
            ...
            , courserun_title
        from ol_data_lake_production.ol_warehouse_production_staging.stg__edxorg__bigquery__mitx_courserun
    )
